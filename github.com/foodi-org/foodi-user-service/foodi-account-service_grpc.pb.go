...
const (
	...
	Account_Login_FullMethodName      = "/foodiUserService.Account/Login"
	Account_PhoneExist_FullMethodName = "/foodiUserService.Account/PhoneExist"
)
...
func (c *accountClient) PhoneExist(ctx context.Context, in *PhoneExistRequest, opts ...grpc.CallOption) (*PhoneExistReply, error) {
	out := new(PhoneExistReply)
	err := c.cc.Invoke(ctx, Account_PhoneExist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServer interface {
	...
	PhoneExist(context.Context, *PhoneExistRequest) (*PhoneExistReply, error)
...
func (UnimplementedAccountServer) PhoneExist(context.Context, *PhoneExistRequest) (*PhoneExistReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PhoneExist not implemented")
}
...
func _Account_PhoneExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PhoneExistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServer).PhoneExist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Account_PhoneExist_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServer).PhoneExist(ctx, req.(*PhoneExistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Account_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PhoneExist",
			Handler:    _Account_PhoneExist_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "foodi-account-service.proto",
}
